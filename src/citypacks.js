...
window.CURIO_CITYPACKS = [
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "answer": 0,
        "fact": "Classic carbonara uses guanciale, pecorino romano, egg and black pepper — no cream; its silkiness comes from egg and cheese alone, not cream.",
  ...
  },
  {
    ...
    "emoji": "🌴",
    "lang": "Yoruba",
    "blurb": "Èkó — the city the world calls Lagos — is a place of islands, creeks and lagoon, where the Awori people first settled and where the city's own music, films and street festivals were born. Loud, generous and always moving, it is West Africa's stage: bridges over water, suya smoke at dusk, a market on every corner and a story in every greeting.",
    "questions": [
      {
