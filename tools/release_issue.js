...
const body = [
  ...
  '',
  'The suite runs across both languages and two screen sizes: the daily five completes,',
  'Next is reachable without scrolling, pictures load with alt text, no question repeats',
  'across three rounds, no English is left on a French screen, nothing is thrown — and,',
  'since 12 September, the links themselves: a greyed door opens nothing when you tap it,',
  'every door that does open is a real address, and a door leads where its own word',
  'promises. Brain Gym and Fact or Fake are played through as well; before that date',
  'neither had a single automated check. Since 21 September the city packs are too:',
  'every pack opens with its questions, phrases and tips in the reader\'s language, and',
  'a French reader is checked to get French Brain Gym puzzles.',
  '',
